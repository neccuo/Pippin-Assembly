...
public class CodeAccessException extends RuntimeException {
	...
	public CodeAccessException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}

	public CodeAccessException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}

	public CodeAccessException(String message, Throwable cause, boolean enableSuppression,
